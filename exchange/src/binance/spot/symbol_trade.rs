...
pub struct SymbolTrade {
    ...
    want_prices: RwLock<HashMap<u64, Decimal>>,
    open_orders: RwLock<HashMap<u64, Arc<Order>>>,
    closed_orders: RwLock<HashMap<u64, Arc<Order>>>,
    trades: RwLock<HashMap<u64, Vec<Arc<Trade>>>>,

    latest_clean_ts: AtomicU64,
}
